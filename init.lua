...
noob = {}
minetest.register_privilege("nmoderator", {description = "Active player Priv.", give_to_singleplayer = true})
...
minetest.register_on_joinplayer(function(player) 
	...
	if isnoob > 0 then
		...
		if privs.nmoderator then
			inv:set_stack("noob", 1, ItemStack("noob"));
			minetest.chat_send_player(name, "#Moderator: welcome moderator. setting as active player.");
			noob.players[name] = 1
		else
			noob.players[name] = 0
